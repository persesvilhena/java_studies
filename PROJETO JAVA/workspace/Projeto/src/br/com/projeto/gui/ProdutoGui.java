...
public class ProdutoGui extends JFrame {
	...
	private void initialize() {
		...
		this.setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/br/com/projeto/imagens/AAAA.png")));
	...
	private JPanel getJPanelMenu() {
		if (jPanelMenu == null) {
			...
			jPanelMenu.setBounds(new java.awt.Rectangle(7,7,627,64));
			jPanelMenu.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, null));
	...
	private JButton getRegistrar() {
		if (registrar == null) {
			...
			registrar.setBounds(new java.awt.Rectangle(37,9,146,46));
	...
	private JButton getBtnListar() {
		if (btnListar == null) {
			...
			btnListar.setBounds(new java.awt.Rectangle(220,9,153,46));
	...
	private JButton getBtnSair() {
		if (btnSair == null) {
			btnSair = new JButton();
			btnSair.setBounds(new java.awt.Rectangle(410,9,177,46));
	...
	private JTabbedPane getPainelTabs() {
		if (painelTabs == null) {
			...
			painelTabs.setBounds(new java.awt.Rectangle(0,88,652,320));
	...
	private JPanel getPainelCadastrar() {
		if (painelCadastrar == null) {
			Est = new JLabel();
			Est.setBounds(new java.awt.Rectangle(28,200,65,22));
			Est.setText("Estoque:");
			Ven = new JLabel();
			Ven.setBounds(new java.awt.Rectangle(28,163,65,22));
			Ven.setText("Venda:");
			Cus = new JLabel();
			Cus.setBounds(new java.awt.Rectangle(28,126,65,22));
			Cus.setText("Custo:");
			Des = new JLabel();
			Des.setBounds(new java.awt.Rectangle(28,89,65,22));
			Des.setText("Descrição:");
			Nom = new JLabel();
			Nom.setBounds(new java.awt.Rectangle(28,52,65,22));
			Nom.setText("Nome:");
			jLabel = new JLabel();
			jLabel.setBounds(new java.awt.Rectangle(28,15,65,22));
	...
	private JTextField getCodigo() {
		if (codigo == null) {
			...
			codigo.setBounds(new java.awt.Rectangle(105,14,514,30));
		}
		return codigo;
	}
	...
	private JTextField getTxtNome() {
		if (txtNome == null) {
			...
			txtNome.setBounds(new java.awt.Rectangle(105,51,514,30));
		}
		return txtNome;
	}
	...
	private JTextField getTxtDescricao() {
		if (txtDescricao == null) {
			...
			txtDescricao.setBounds(new java.awt.Rectangle(105,88,514,30));
		}
		return txtDescricao;
	}
	...
	private JTextField getTxtVenda() {
		if (txtVenda == null) {
			...
			txtVenda.setBounds(new java.awt.Rectangle(105,162,514,30));
		}
		return txtVenda;
	}
	...
	private JTextField getTxtEstoque() {
		if (txtEstoque == null) {
			...
			txtEstoque.setBounds(new java.awt.Rectangle(105,199,514,30));
		}
		return txtEstoque;
	}
	...
	private JPanel getPainelConsultar() {
		if (painelConsultar == null) {
			...
			NomeConsultar.setBounds(new java.awt.Rectangle(8,11,127,22));
	...
	private JButton getBtnSalvar() {
		if (btnSalvar == null) {
			...
			btnSalvar.setBounds(new java.awt.Rectangle(67,236,79,33));
	...
	private JButton getBtnAlterar() {
		if (btnAlterar == null) {
			...
			btnAlterar.setBounds(new java.awt.Rectangle(208,236,79,33));
	...
	private JButton getBtnExcluir() {
		if (btnExcluir == null) {
			...
			btnExcluir.setBounds(new java.awt.Rectangle(349,236,79,33));
	...
	private JButton getBtnLimpar() {
		if (btnLimpar == null) {
			...
			btnLimpar.setBounds(new java.awt.Rectangle(490,236,79,33));
	...
	private JTextField getTxtCusto() {
		if (txtCusto == null) {
			...
			txtCusto.setBounds(new java.awt.Rectangle(105,125,514,30));
		}
		return txtCusto;
	}
	...
	private JTextField getTxtNomeConsultar() {
		if (txtNomeConsultar == null) {
			...
			txtNomeConsultar.setBounds(new java.awt.Rectangle(141,7,258,30));
	...
	private JScrollPane getPainelconsultar() {
		if (painelconsultar == null) {
			...
			painelconsultar.setBounds(new java.awt.Rectangle(6,47,635,240));
