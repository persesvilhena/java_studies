...
public class CidadeGui extends JFrame {
	...
	private void initialize() {
		...
		this.setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/br/com/projeto/imagens/1404034408_companies.png")));
...
public void	evento_tabela_preenche_campos(){
	...
	private JPanel getJPanelBotoes() {
		if (jPanelBotoes == null) {
			...
			jPanelBotoes.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, null));
	...
	private JTabbedPane getPainelTabs() {
		if (painelTabs == null) {
			...
			painelTabs.setBounds(new java.awt.Rectangle(0,78,494,244));
	...
	private JPanel getPainelCadastrar() {
		if (painelCadastrar == null) {
			labelUf = new JLabel();
			labelUf.setBounds(new java.awt.Rectangle(30,116,120,35));
			labelUf.setText("Uf:");
			labelNome = new JLabel();
			labelNome.setBounds(new java.awt.Rectangle(30,63,120,35));
			labelNome.setText("Nome:");
			labelCodigo = new JLabel();
			labelCodigo.setBounds(new java.awt.Rectangle(30,10,120,35));
	...
	private JTextField getTxtCodigo() {
		if (txtCodigo == null) {
			...
			txtCodigo.setBounds(new java.awt.Rectangle(170,11,280,35));
		}
		return txtCodigo;
	}
	...
	private JTextField getTxtNome() {
		if (txtNome == null) {
			...
			txtNome.setBounds(new java.awt.Rectangle(170,64,280,35));
		}
		return txtNome;
	}
	...
	private JTextField getTxtUf() {
		if (txtUf == null) {
			...
			txtUf.setBounds(new java.awt.Rectangle(170,117,280,35));
		}
		return txtUf;
	}
	...
	private JButton getBtnSalvar() {
		if (btnSalvar == null) {
			...
			btnSalvar.setBounds(new java.awt.Rectangle(29,159,101,45));
	...
	private JButton getBtnAlterar() {
		if (btnAlterar == null) {
			...
			btnAlterar.setBounds(new java.awt.Rectangle(139,159,98,45));
	...
	private JButton getBtnExcluir() {
		if (btnExcluir == null) {
			...
			btnExcluir.setBounds(new java.awt.Rectangle(246,159,97,45));
	...
	private JButton getBtnLimpar() {
		if (btnLimpar == null) {
			...
			btnLimpar.setBounds(new java.awt.Rectangle(352,159,97,45));
	...
	private JScrollPane getPainelconsultar() {
		if (painelconsultar == null) {
			...
			painelconsultar.setBounds(new java.awt.Rectangle(10,41,457,169));
