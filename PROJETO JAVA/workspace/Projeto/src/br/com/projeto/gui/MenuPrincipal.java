...
public class MenuPrincipal extends JFrame {
	...
	private JMenuItem ItemCidade = null;
	private JMenuItem ItemFornecedores = null;
	/**
	...
	private JMenu getJMenuCadastro() {
		if (JMenuCadastro == null) {
			...
			JMenuCadastro.add(getItemCidade());
			JMenuCadastro.add(getItemFornecedores());
		}
	...
	private JMenu getJMenuRelatorios() {
		if (JMenuRelatorios == null) {
			...
			JMenuRelatorios.setMnemonic(java.awt.event.KeyEvent.VK_UNDEFINED);
	...
	/**
	 * This method initializes ItemCidade	
	 * 	
	 * @return javax.swing.JMenuItem	
	 */
	private JMenuItem getItemCidade() {
		if (ItemCidade == null) {
			ItemCidade = new JMenuItem();
			ItemCidade.setIcon(new ImageIcon(getClass().getResource("/br/com/projeto/imagens/1404034408_companies.png")));
			ItemCidade.setText("Cidade");
			ItemCidade.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					CidadeGui telacidade = new CidadeGui();
	...
	/**
	 * This method initializes ItemFornecedores	
	 * 	
	 * @return javax.swing.JMenuItem	
	 */
	private JMenuItem getItemFornecedores() {
		if (ItemFornecedores == null) {
			ItemFornecedores = new JMenuItem();
			ItemFornecedores.setIcon(new ImageIcon(getClass().getResource("/br/com/projeto/imagens/AAAAA.png")));
	...
	private void initialize() {
		...
		this.setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/br/com/projeto/imagens/1404036410_th-menu.png")));
