...
public class ServicoGui extends JFrame {
	...
	private JTabbedPane getPainelTabs() {
		if (painelTabs == null) {
			...
			painelTabs.setBounds(new java.awt.Rectangle(0,83,615,334));
	...
	private JTextField getTxtNomeConsultar() {
		if (txtNomeConsultar == null) {
			...
			txtNomeConsultar.setBounds(new java.awt.Rectangle(160,13,240,30));
	...
	private JScrollPane getJScrollPane() {
		if (jScrollPane == null) {
			...
			jScrollPane.setBounds(new java.awt.Rectangle(6,56,599,246));
	...
	private void initialize() {
		...
		this.setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/br/com/projeto/imagens/CCCC.png")));
