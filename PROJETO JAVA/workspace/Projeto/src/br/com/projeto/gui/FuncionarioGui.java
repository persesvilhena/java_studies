...
public class FuncionarioGui extends JFrame {
	...
	private JPanel getPainelBotoes() {
		if (painelBotoes == null) {
			...
			painelBotoes.setBounds(new java.awt.Rectangle(18,7,741,60));
	...
	private JButton getBtnRegistrar() {
		if (btnRegistrar == null) {
			...
			btnRegistrar.setBounds(new java.awt.Rectangle(69,9,165,37));
	...
	private JButton getBtnListar() {
		if (btnListar == null) {
			...
			btnListar.setBounds(new java.awt.Rectangle(303,9,155,37));
	...
	private JButton getBtnSair() {
		if (btnSair == null) {
			btnSair = new JButton();
			btnSair.setBounds(new java.awt.Rectangle(527,9,145,37));
	...
	private JTabbedPane getPainelTabs() {
		if (painelTabs == null) {
			...
			painelTabs.setBounds(new java.awt.Rectangle(0,83,795,340));
	...
	private JButton getBtnSalvar() {
		if (btnSalvar == null) {
			...
			btnSalvar.setBounds(new java.awt.Rectangle(27,249,95,43));
	...
	private JButton getBtnAlterar() {
		if (btnAlterar == null) {
			...
			btnAlterar.setBounds(new java.awt.Rectangle(131,249,91,43));
	...
	private JButton getBtnExcluir() {
		if (btnExcluir == null) {
			...
			btnExcluir.setBounds(new java.awt.Rectangle(231,249,90,43));
	...
	private JButton getBtnLimpar() {
		if (btnLimpar == null) {
			...
			btnLimpar.setBounds(new java.awt.Rectangle(330,249,97,43));
	...
	private JTextField getTxtNomeConsultar() {
		if (txtNomeConsultar == null) {
			...
			txtNomeConsultar.setBounds(new java.awt.Rectangle(159,14,240,30));
	...
	private JScrollPane getJScrollPane() {
		if (jScrollPane == null) {
			...
			jScrollPane.setBounds(new java.awt.Rectangle(4,56,781,238));
	...
	private void initialize() {
		...
		this.setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/br/com/projeto/imagens/AA.png")));
