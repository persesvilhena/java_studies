...
public class FornecedorGui extends JFrame {
	...
	private JPanel getPainelBotoes() {
		if (painelBotoes == null) {
			...
			painelBotoes.setBounds(new java.awt.Rectangle(13,9,589,64));
	...
	private JButton getBtnRegistrar() {
		if (btnRegistrar == null) {
			...
			btnRegistrar.setBounds(new java.awt.Rectangle(35,10,132,42));
	...
	private JButton getBtnListar() {
		if (btnListar == null) {
			...
			btnListar.setBounds(new java.awt.Rectangle(202,10,146,42));
	...
	private JButton getBtnSair() {
		if (btnSair == null) {
			btnSair = new JButton();
			btnSair.setBounds(new java.awt.Rectangle(383,10,171,42));
	...
	private JTabbedPane getPainelTabs() {
		if (painelTabs == null) {
			...
			painelTabs.setBounds(new java.awt.Rectangle(2,83,612,334));
	...
	private JPanel getPainelCadastrar() {
		if (painelCadastrar == null) {
			jlObs = new JLabel();
			jlObs.setBounds(new java.awt.Rectangle(7,199,84,23));
			jlObs.setText("Observação:");
			jlCnpj = new JLabel();
			jlCnpj.setBounds(new java.awt.Rectangle(7,135,54,21));
			jlCnpj.setText("Cnpj:");
			jlEmail = new JLabel();
			jlEmail.setBounds(new java.awt.Rectangle(5,103,38,16));
			jlEmail.setText("Email:");
			jlTelefone = new JLabel();
			jlTelefone.setBounds(new java.awt.Rectangle(5,170,54,16));
			jlTelefone.setText("Telefone:");
			jlEndereco = new JLabel();
			jlEndereco.setBounds(new java.awt.Rectangle(5,77,61,16));
			jlEndereco.setText("Endereço:");
			jlNome = new JLabel();
			jlNome.setBounds(new java.awt.Rectangle(5,46,38,16));
			jlNome.setText("Nome:");
			jlCodigo = new JLabel();
			jlCodigo.setBounds(new java.awt.Rectangle(5,15,52,16));
	...
	private JTextField getTxtCodigo() {
		if (txtCodigo == null) {
			...
			txtCodigo.setBounds(new java.awt.Rectangle(86,14,100,30));
		}
		return txtCodigo;
	}
	...
	private JTextField getTxtNome() {
		if (txtNome == null) {
			...
			txtNome.setBounds(new java.awt.Rectangle(86,44,300,30));
		}
		return txtNome;
	}
	...
	private JTextField getTxtEndereco() {
		if (txtEndereco == null) {
			...
			txtEndereco.setBounds(new java.awt.Rectangle(86,73,300,30));
		}
		return txtEndereco;
	}
	...
	private JFormattedTextField getTxtTelefone() {
		if (txtTelefone == null) {
			...
			txtTelefone.setBounds(new java.awt.Rectangle(86,170,100,30));
		}
		return txtTelefone;
	}
	...
	private JTextField getTxtEmail() {
		if (txtEmail == null) {
			...
			txtEmail.setBounds(new java.awt.Rectangle(86,103,300,30));
		}
		return txtEmail;
	}
	...
	private JButton getBtnSalvar() {
		if (btnSalvar == null) {
			...
			btnSalvar.setBounds(new java.awt.Rectangle(15,257,90,41));
	...
	private JButton getBtnAlterar() {
		if (btnAlterar == null) {
			...
			btnAlterar.setBounds(new java.awt.Rectangle(118,257,87,41));
	...
	private JButton getBtnExcluir() {
		if (btnExcluir == null) {
			...
			btnExcluir.setBounds(new java.awt.Rectangle(218,257,87,41));
	...
	private JButton getBtnLimpar() {
		if (btnLimpar == null) {
			...
			btnLimpar.setBounds(new java.awt.Rectangle(318,257,88,41));
	...
	private JPanel getPainelConsultar() {
		if (painelConsultar == null) {
			...
			jlNomeConsultar.setBounds(new java.awt.Rectangle(12,19,125,16));
	...
	private JTextField getTxtNomeConsultar() {
		if (txtNomeConsultar == null) {
			...
			txtNomeConsultar.setBounds(new java.awt.Rectangle(147,14,240,30));
	...
	private JScrollPane getJScrollPane() {
		if (jScrollPane == null) {
			...
			jScrollPane.setBounds(new java.awt.Rectangle(6,56,592,243));
	...
	private JTextField getTxtCnpj() {
		if (txtCnpj == null) {
			...
			txtCnpj.setBounds(new java.awt.Rectangle(86,135,300,30));
		}
		return txtCnpj;
	}
	...
	private JTextField getTxtObs() {
		if (txtObs == null) {
			...
			txtObs.setBounds(new java.awt.Rectangle(86,200,300,30));
		}
		return txtObs;
	}
