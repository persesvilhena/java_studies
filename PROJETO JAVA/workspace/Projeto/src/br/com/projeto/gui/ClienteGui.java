...
public class ClienteGui extends JFrame {
	...
	private JPanel getPainelBotoes() {
		if (painelBotoes == null) {
			...
			painelBotoes.setBounds(new java.awt.Rectangle(11,9,759,64));
			painelBotoes.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, null));
	...
	private JButton getBtnRegistrar() {
		if (btnRegistrar == null) {
			...
			btnRegistrar.setBounds(new java.awt.Rectangle(48,8,194,42));
	...
	private JButton getBtnListar() {
		if (btnListar == null) {
			...
			btnListar.setBounds(new java.awt.Rectangle(290,8,192,42));
	...
	private JButton getBtnSair() {
		if (btnSair == null) {
			btnSair = new JButton();
			btnSair.setBounds(new java.awt.Rectangle(530,8,181,42));
	...
	private JTabbedPane getPainelTabs() {
		if (painelTabs == null) {
			...
			painelTabs.setBounds(new java.awt.Rectangle(0,83,791,339));
	...
	private JTextField getTxtCodigo() {
		if (txtCodigo == null) {
			...
			txtCodigo.setBounds(new java.awt.Rectangle(93,15,88,30));
		}
		return txtCodigo;
	}
	...
	private JTextField getTxtNome() {
		if (txtNome == null) {
			...
			txtNome.setBounds(new java.awt.Rectangle(73,46,356,30));
		}
		return txtNome;
	}
	...
	private JTextField getTxtEndereco() {
		if (txtEndereco == null) {
			...
			txtEndereco.setBounds(new java.awt.Rectangle(99,77,237,30));
		}
		return txtEndereco;
	}
	...
	private JTextField getTxtNumero() {
		if (txtNumero == null) {
			...
			txtNumero.setBounds(new java.awt.Rectangle(385,77,44,30));
		}
		return txtNumero;
	}
	...
	private JTextField getTxtBairro() {
		if (txtBairro == null) {
			...
			txtBairro.setBounds(new java.awt.Rectangle(77,108,201,30));
		}
		return txtBairro;
	}
	...
	private JFormattedTextField getTxtCep() {
		if (txtCep == null) {
			...
			txtCep.setBounds(new java.awt.Rectangle(337,108,92,30));
		}
		return txtCep;
	}
	...
	private JComboBox getCboCidade() {
		if (cboCidade == null) {
			...
			cboCidade.setBounds(new java.awt.Rectangle(82,139,120,30));
		}
		return cboCidade;
	}
	...
	private JTextField getTxtEstado() {
		if (txtEstado == null) {
			...
			txtEstado.setBounds(new java.awt.Rectangle(262,139,167,30));
		}
		return txtEstado;
	}
	...
	private JFormattedTextField getTxtTelefone() {
		if (txtTelefone == null) {
			...
			txtTelefone.setBounds(new java.awt.Rectangle(86,170,89,30));
		}
		return txtTelefone;
	}
	...
	private JTextField getTxtEmail() {
		if (txtEmail == null) {
			...
			txtEmail.setBounds(new java.awt.Rectangle(227,170,202,30));
		}
		return txtEmail;
	}
	...
	private JFormattedTextField getTxtCpf() {
		if (txtCpf == null) {
			...
			txtCpf.setBounds(new java.awt.Rectangle(54,199,95,30));
		}
		return txtCpf;
	}
	...
	private JFormattedTextField getTxtRg() {
		if (txtRg == null) {
			...
			txtRg.setBounds(new java.awt.Rectangle(183,199,92,30));
		}
		return txtRg;
	}
	...
	private JButton getBtnSalvar() {
		if (btnSalvar == null) {
			...
			btnSalvar.setBounds(new java.awt.Rectangle(27,257,78,32));
	...
	private JButton getBtnAlterar() {
		if (btnAlterar == null) {
			...
			btnAlterar.setBounds(new java.awt.Rectangle(128,257,78,32));
	...
	private JButton getBtnExcluir() {
		if (btnExcluir == null) {
			...
			btnExcluir.setBounds(new java.awt.Rectangle(229,257,78,32));
	...
	private JButton getBtnLimpar() {
		if (btnLimpar == null) {
			...
			btnLimpar.setBounds(new java.awt.Rectangle(330,257,78,32));
	...
	private JTextField getTxtNomeConsultar() {
		if (txtNomeConsultar == null) {
			...
			txtNomeConsultar.setBounds(new java.awt.Rectangle(159,20,240,30));
	...
	private JScrollPane getJScrollPane() {
		if (jScrollPane == null) {
			...
			jScrollPane.setBounds(new java.awt.Rectangle(5,56,780,253));
	...
	private JFormattedTextField getTxtNascimento() {
		if (txtNascimento == null) {
			...
			txtNascimento.setBounds(new java.awt.Rectangle(351,200,75,30));
		}
	...
	private void initialize() {
		...
		this.setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/br/com/projeto/imagens/AAA.png")));
