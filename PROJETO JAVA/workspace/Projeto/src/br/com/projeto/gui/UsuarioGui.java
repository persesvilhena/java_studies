...
public class UsuarioGui extends JFrame {
	...
	private JPanel getPainelBotoes() {
		if (PainelBotoes == null) {
			...
			PainelBotoes.setBounds(new java.awt.Rectangle(15,9,700,60));
	...
	private JButton getBtnRegistrar() {
		if (btnRegistrar == null) {
			...
			btnRegistrar.setBounds(new java.awt.Rectangle(83,6,118,45));
	...
	private JButton getBtnListar() {
		if (btnListar == null) {
			...
			btnListar.setBounds(new java.awt.Rectangle(284,6,128,45));
	...
	private JButton getBtnSair() {
		if (btnSair == null) {
			btnSair = new JButton();
			btnSair.setBounds(new java.awt.Rectangle(495,6,122,45));
	...
	private JTabbedPane getPainelTabs() {
		if (painelTabs == null) {
			...
			painelTabs.setBounds(new java.awt.Rectangle(0,94,734,370));
	...
	private JTextField getTxtCodigo() {
		if (txtCodigo == null) {
			...
			txtCodigo.setBounds(new java.awt.Rectangle(150,10,450,30));
		}
		return txtCodigo;
	}
	...
	private JTextField getTxtNome() {
		if (txtNome == null) {
			...
			txtNome.setBounds(new java.awt.Rectangle(150,43,450,30));
		}
		return txtNome;
	}
	...
	private JTextField getTxtLogin() {
		if (txtLogin == null) {
			...
			txtLogin.setBounds(new java.awt.Rectangle(150,77,450,30));
		}
		return txtLogin;
	}
	...
	private JPasswordField getTxtSenha() {
		if (txtSenha == null) {
			...
			txtSenha.setBounds(new java.awt.Rectangle(150,111,450,30));
		}
		return txtSenha;
	}
	...
	private JComboBox getCboTipo() {
		if (cboTipo == null) {
			...
			cboTipo.setBounds(new java.awt.Rectangle(150,146,450,30));
		}
		return cboTipo;
	}
	...
	private JFormattedTextField getTxtData() {
		if (txtData == null) {
			...
			txtData.setBounds(new java.awt.Rectangle(150,178,450,30));
		}
		return txtData;
	}
	...
	private JFormattedTextField getTxtCpf() {
		if (txtCpf == null) {
			...
			txtCpf.setBounds(new java.awt.Rectangle(150,215,450,30));
		}
		return txtCpf;
	}
	...
	private JComboBox getCboCidade() {
		if (cboCidade == null) {
			...
			cboCidade.setBounds(new java.awt.Rectangle(150,249,450,30));
		}
		return cboCidade;
	}
	...
	private JScrollPane getJScrollPane() {
		if (jScrollPane == null) {
			...
			jScrollPane.setBounds(new java.awt.Rectangle(14,44,702,287));
